            ...
            <div className="max-w-2x1 mx-auto p-4 sm:p-6 lg:p-8">
                <form onSubmit={submit}>
                    ...
                    <textarea
                        ...
                        placeholder="Body"
                        className="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-4"
                    />
                ...
                <div className="mt-6 bg-indigo-400 rounded-lg divide-y">
                    {posts.map(post => (
