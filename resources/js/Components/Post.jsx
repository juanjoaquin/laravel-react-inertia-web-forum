          ...
          <div>
            {post.user.id === auth.user.id && (
              <Dropdown>
                ...
                <Dropdown.Content>
                  <button onClick={() => setEditing(true)} className="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-200 focus:bg-gray-100 transition duration-150 ease-in-out">
                    Editar</button>
                  
                  <Dropdown.Link as="button" href={route('posts.destroy', post.id)} method='delete'> 
                    Delete </Dropdown.Link>
                </Dropdown.Content>
          ...
          {editing ? (
            <form onSubmit={submit}>
              ...
              <button
                ...
                onClick={() => setEditing(false) && reset()}>Cancelar</button>
